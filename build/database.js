...
var Database = /*#__PURE__*/function () {
  ...
  _createClass(Database, [{
    ...
    key: "get",
    value: function () {
      var _get = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(query, params) {
        var _this = this;
    ...
    value: function insert(query, args) {
      ...
      (_this$db = this.db).run.apply(_this$db, [query].concat(_toConsumableArray(args)));
    }
  }, {
    key: "close",
